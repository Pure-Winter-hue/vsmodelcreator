...
public class ControlsDialog
{
	public static void show(JFrame parent)
	{
		...
		message.setText("<html>"
				...
				+ "<ul>"
				+ "<li>Pan: hold middle mouse button (or hold Alt + right mouse button)</li>"
				+ "<li>Rotate: hold right mouse button</li>"
				+ "<li>Use the mouse wheel or +/- keys to zoom in/out</li>"
				+ "<li>Use the arrow keys or Pg Up/Pg Down to move a selected element</li>"
				+ "<li>Click the left mouse button to select an element (Cube/Keyframe tab)</li>"
				+ "<li>In Face tab: click a face to select that face (and the element)</li>"
